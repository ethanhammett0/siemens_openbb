...
This skill guides any AI agent through a complete pipeline for building OpenBB apps:
...
- **Agent-agnostic**: `.agents/skills/openbb-app-builder/SKILL.md`
- **Claude Code**: `.claude/skills/openbb-app-builder/SKILL.md`
