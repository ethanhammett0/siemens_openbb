...
**CRITICAL**: apps.json is an ARRAY `[{...}]`, not an object. Must be served via `GET /apps.json` endpoint.

For complete apps.json structure, see [OPENBB-APP.md](OPENBB-APP.md).
